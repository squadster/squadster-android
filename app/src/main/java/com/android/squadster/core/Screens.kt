...
import com.android.squadster.ui.squadsettings.SquadSettingsFragment
...
object Screens {
    ...
    object SquadSettings : SupportAppScreen() {

        override fun getFragment() = SquadSettingsFragment()
    }
}